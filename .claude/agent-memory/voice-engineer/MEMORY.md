...
- [M18 eye action seam](project_m18_eye_action_seam.md) — 2026-09-06 EyeStore does the durable eye POST on the voice path too; server verified-vs-already must account for it
