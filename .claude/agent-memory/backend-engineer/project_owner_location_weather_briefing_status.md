...
description: Owner Location Context / Live Weather / Morning Briefing (docs/DECISIONS.md ADR-0090) completed 2026-09-09 on branch worktree-agent-a6616e449e5a5cf7e; not merged/pushed; live weather NOT_YET_PROVEN against the real Open-Meteo API (no outbound network in this sandbox)
metadata:
  type: project
---
...
branch `worktree-agent-a6616e449e5a5cf7e`. Full detail in `docs/DECISIONS.md` ADR-0090 —
...
**Real bugs found and fixed, each with a regression test** (see ADR-0090 for the full
...
Coarse IP geolocation is unconfigured (no vendor hardcoded, on purpose — see ADR-0090
