...
**Names** (`AgentCapabilities.Documents`, 6, no family marker — every name is an operation): `file.search`, `file.locate`, `file.inspect`, `file.read`, `file.compare`, `document.extract`. There is no delete, move or write name (ADR-0083 decision 7).
