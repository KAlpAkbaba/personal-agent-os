...
**Addendum — the web side of contract v5 (track C, 2026-09-08).** Recorded here rather than as a new ADR because every choice is a reading of §3 of the spec and of ADR-0052's rule that the Core shows only what was published.
