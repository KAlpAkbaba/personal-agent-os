...
| 6 | /v1/world/facts secret redaction | DB parolası açık metin dönüyor | Sır hiçbir yanıtta yok | DONE | PR | P0 | — | B04 | app/worldmodel/state.py:_Collector.fact, app/security/redaction.py:strip_uri_credentials | test_secret_redaction_surfaces.py | üretim P0 turu 6fa7dfe (docs/evidence/p0-production-round-2026-09-17-040952.json) | no | Redaksiyon toplayıcı kapısında; DSN'in yalnız userinfo'su siliniyor, host/veritabanı duruyor |
| 7 | Log secret redaction | 13 desen log hattında yok | Sır loga düşmez | DONE | PR | P0 | 6 | B04 | app/logging.py:redact_secrets, app/logging.py:SecretRedactingFilter | test_secret_redaction_surfaces.py | üretim P0 turu 6fa7dfe (docs/evidence/p0-production-round-2026-09-17-040952.json) | no | structlog zinciri + stdlib handler filtresi (uvicorn/SQLAlchemy oradan yazıyor) |
| 8 | Health secret redaction | Kimliksiz sağlıkta desen yok | Sağlık sır sızdırmaz | DONE | PR | P0 | 6 | B04 | app/health.py:_run_check, app/main.py:system_health | test_secret_redaction_surfaces.py, test_health_endpoint.py | üretim P0 turu 6fa7dfe (docs/evidence/p0-production-round-2026-09-17-040952.json) | no | Kimliksiz uç: hem hata dizesi hem tüm checks haritası |
| 9 | Dead Voice session sweeper | 6-7 zombie `active`, en eskisi 09-09 | Zombie kalmaz | DONE | PR | P0 | — | B06 | app/voice/realtime_sessions/service.py:sweep_idle_sessions, app/main.py:RetentionSweeper | test_orphan_sweeps.py | üretim P0 turu 6fa7dfe (docs/evidence/p0-production-round-2026-09-17-040952.json) | no | Yaş değil atıllık: konuşulan oturum hiç süpürülmez |
| 10 | Takılmış research/task sweeper | 09-09'dan beri `discovering` | Terminal duruma taşınır | DONE | PR | P0 | — | B06 | app/research/service.py:sweep_abandoned_runs, app/main.py:RetentionSweeper | test_orphan_sweeps.py | üretim P0 turu 6fa7dfe (docs/evidence/p0-production-round-2026-09-17-040952.json) | no | Görev FAILED_TERMINAL, koşu STAGE_FAILED; satır silinmez |
| 11 | Stale RUNNING/CREATED reconciliation | Mutabakat yok | Durum gerçeğe uyar | DONE | PR | P0 | 10 | B06 | app/research/service.py:sweep_abandoned_runs, app/worldmodel/state.py:_collect_tasks | test_orphan_sweeps.py, test_worldmodel.py | üretim P0 turu 6fa7dfe (docs/evidence/p0-production-round-2026-09-17-040952.json) | no | Süpürge taşır, dünya modeli sayar |
...
| 13 | Orphan research row cleanup | Yetim koşu temizlenmiyor | Yetim kalmaz | DONE | PR | P0 | 10 | B06 | app/research/service.py:sweep_abandoned_runs | test_orphan_sweeps.py | üretim P0 turu 6fa7dfe (docs/evidence/p0-production-round-2026-09-17-040952.json) | no | 10 ile tek uygulama |
| 14 | Retry loop'ları bounded | Üç sınırsız döngü | Sınırlı geri çekilme | DONE | PR | P0 | — | B07 | app/notifications/delivery.py | test_bounded_delivery.py | üretim P0 turu 6fa7dfe (docs/evidence/p0-production-round-2026-09-17-040952.json) | no | Üç kuyruğun ortak politikası: deneme sayısı, tavanlı geri çekilme, karantina |
| 15 | Push announcer bounded retry | Kalıcı arızada günde 17.280 deneme | Sınırlı deneme | DONE | PR | P0 | 14 | B07 | app/notifications/delivery.py, app/mobile/announcer.py | test_bounded_delivery.py, test_mobile_announcer.py | üretim P0 turu 6fa7dfe (docs/evidence/p0-production-round-2026-09-17-040952.json) | no | 17.280/gün bitti; başarısız görev karantinaya, kuyruk ilerliyor |
| 16 | Briefing announcer kuyruk kilidi yok | Tek bozuk satır kuyruğu kalıcı tıkıyor | Zehirli mesaj karantinaya | DONE | PR | P0 | 14 | B07 | app/notifications/delivery.py, app/ledger/briefing.py:pending | test_bounded_delivery.py | üretim P0 turu 6fa7dfe (docs/evidence/p0-production-round-2026-09-17-040952.json) | no | Zehirli satır artık kenara çekiliyor: kırmızı kanıtlandı |
| 17 | Research announcer bounded retry | Sınırsız | Sınırlı | DONE | PR | P0 | 14 | B07 | app/notifications/delivery.py, app/voice/realtime_sessions/research_announcer.py | test_bounded_delivery.py | üretim P0 turu 6fa7dfe (docs/evidence/p0-production-round-2026-09-17-040952.json) | no | Karantina 'duyuramadık' der, 'araştırma başarısız' demez |
...
| 19 | Routine clock alt bileşen izolasyonu | Tek try/except; bir tik patlarsa hepsi düşer | Alt tikler bağımsız | DONE | PR | P0 | 18 | B07 | app/routines/clock.py:_run_tick | test_bounded_delivery.py, test_routines_clock.py | üretim P0 turu 6fa7dfe (docs/evidence/p0-production-round-2026-09-17-040952.json) | no | Beş alt tik izole + başarısızlıktan sonra rollback |
...
| 67 | World model terminal-state accuracy | `tasks.running=10` yanlış | Doğru sayım | DONE | PR | P0 | — | B06 | app/artifacts/state.py:TASK_*_STATUSES, app/worldmodel/state.py:_collect_tasks | test_task_status_meaning.py, test_worldmodel.py | üretim P0 turu 6fa7dfe (docs/evidence/p0-production-round-2026-09-17-040952.json) | no | Dört anlam kovası; her durum tam olarak bir kovada |
| 68 | READY research running sayılmasın | Biten iş "çalışıyor" görünüyor | Doğru | DONE | PR | P0 | 67 | B06 | app/artifacts/state.py:TASK_*_STATUSES, app/worldmodel/state.py:_collect_tasks | test_task_status_meaning.py, test_worldmodel.py | üretim P0 turu 6fa7dfe (docs/evidence/p0-production-round-2026-09-17-040952.json) | no | READY artık awaiting_owner, running değil |
| 69 | Stuck task detection | Yok | Tespit edilir | DONE | PR | P0 | 10 | B06 | app/worldmodel/state.py:_collect_tasks:STUCK_TASK_AFTER | test_worldmodel.py | üretim P0 turu 6fa7dfe (docs/evidence/p0-production-round-2026-09-17-040952.json) | no | tasks.stuck_count, 24 saat |
| 70 | Ledger duplicate Voice event prevention | Her sesli oturum iki satır | Tek satır | DONE | PR | P0 | — | B06 | app/ledger/service.py:voice_session_source_ref, app/ledger/service.py:_voice_live_already_recorded | test_ledger_service.py, test_voice_realtime_sessions.py | üretim P0 turu 6fa7dfe (docs/evidence/p0-production-round-2026-09-17-040952.json) | no | Doğal anahtar = canlı yazarın kendi anahtarı; tek tanım, iki yarı |
...
| 143 | EPUB read | OpenPackageExtractor: container.xml → OPF → omurga sırasıyla XHTML bölümleri; DOCX şeması (p<n>, t<n> hücre ızgarası), başlık dc:title, `structure.chapters`; başlık seviyesi yalnız h1-h6'dan (LibreOffice başlıkları stilli <p> yazar → paragraf); her parça şişerken sayılır (16 MiB), XML dış varlık çözmez, arşivden çıkan href yok sayılır | Okunur | DONE | PA | P2 | — | B52 | devices/windows-agent/.../Documents/OpenPackageExtractor.cs | ExtractionOracleTests (legacy/*) · LegacyFormatBoundsTests (gerçek LibreOffice EPUB'ı; XXE; href kaçışı; şişme sınırı) · test_documents_b52.py | — | no | — |
| 144 | RTF read | RtfExtractor: sınırlı kontrol sözcüğü ayrıştırıcı (4 MiB önek, 256 grup derinliği); başlık seviyeleri dosyanın stil sayfası adlarından, tablolar \cell/\row'dan, \ansicpg kod sayfası + \uN; \info'dan yalnız başlık (\ud Unicode alternatifi tercih), yazar/yorum metne sızmaz | Okunur | DONE | PA | P2 | — | B52 | .../Documents/RtfExtractor.cs | ExtractionOracleTests (legacy/*) · LegacyFormatBoundsTests (gerçek LibreOffice RTF'i = DOCX kâhini; derinlik bombası; üst veri sızmaz) · test_documents_b52.py | — | no | — |
| 145 | ODT read | OpenPackageExtractor: content.xml'den text:h (outline-level) / text:p / table:table; DOCX şemasının birebiri (başlıklar, seviyeler, tablo ızgarası); başlık meta.xml dc:title; manifest şifrelemesi `encrypted` ile adıyla reddedilir; DTD yasak | Okunur | DONE | PA | P2 | — | B52 | .../Documents/OpenPackageExtractor.cs | ExtractionOracleTests (legacy/*) · LegacyFormatBoundsTests (gerçek LibreOffice ODT'si = DOCX kâhini; şifreli ODT reddi) · test_documents_b52.py | — | no | — |
| 146 | Legacy Office formats | CompoundFile (sınırlı OLE okuyucu: zincir döngüsü parse_failed, akış 64 MiB) + LegacyOfficeExtractor: .doc parça tablosu (alan komutu atılır, sonucu kalır; yalnız paragraflar), .xls BIFF8 (SST+CONTINUE, LABELSST/NUMBER/RK/MULRK/FORMULA; formül belirteçleri `=` metnine çözülür, bilinmeyen belirteçte önbellek değeri), .ppt (slayt listesi ana hattı ya da slayt kapları; başlık yer tutucusu); şifreli dosya `encrypted` | .doc/.xls/.ppt okunur | DONE | PA | P2 | — | B52 | .../Documents/CompoundFile.cs; LegacyOfficeExtractor.cs | ExtractionOracleTests (legacy/*) · LegacyFormatBoundsTests (gerçek LibreOffice DOC/XLS/PPT = kaynak kâhinleri; bozuk başlık; formül çözücü) · test_documents_b52.py | — | no | DOC başlık seviyeleri özellik sayfalarında - okunmaz |
...
| 206 | Orphan cleanup | Yok | Temizlenir | DONE | PR | P0 | 10 | B06 | app/research/service.py:sweep_abandoned_runs | test_orphan_sweeps.py | üretim P0 turu 6fa7dfe (docs/evidence/p0-production-round-2026-09-17-040952.json) | no | 10, 13 ile tek uygulama |
...
| 219 | Dead session cleanup | Yok | Süpürülür | DONE | PR | P0 | — | B06 | app/voice/realtime_sessions/service.py:sweep_idle_sessions, app/main.py:RetentionSweeper | test_orphan_sweeps.py | üretim P0 turu 6fa7dfe (docs/evidence/p0-production-round-2026-09-17-040952.json) | no | 9 ile tek uygulama |
| 220 | Session TTL | Yok | Ömür sınırı | DONE | PR | P0 | 219 | B06 | app/voice/realtime_sessions/service.py:sweep_idle_sessions:IDLE_SESSION_AFTER | test_orphan_sweeps.py | üretim P0 turu 6fa7dfe (docs/evidence/p0-production-round-2026-09-17-040952.json) | no | ADR-0105 gereği mutlak ömür DEĞİL, 12 saat atıllık sınırı |
...
| 245 | Speaker verification | Tavsiye niteliğinde; verdict'i okuyan yok | Karar yolunda | DEFERRED | PA | P0 | — | B05 | app/security/step_up.py, app/voice/realtime_sessions/service.py:handle_tool_call | test_voice_step_up.py | sahip kararı 2026-09-19: ses izi kimlik doğrulaması istenmiyor | no | Karar yolu gölge modda kalır; sahip ikinci ses onayını ve ses izini istemiyor (ADR-0171 eki). VoiceIdentity yalnız dinleme modunda filtre. |
| 246 | Trusted-device check | `device_trusted` istek gövdesinden geliyor | Sunucu tarafında doğrulanır | DONE | PR | P0 | 663 | B05 | app/voice/device_trust.py, app/voice/routes.py:verify_speaker_route | test_authority_gate.py | üretim P0 turu 6fa7dfe (docs/evidence/p0-production-round-2026-09-17-040952.json) | no | Alan kaldırıldı: gönderen 422 alıyor, sessizce yok sayılmıyor |
| 247 | Speaker-confidence threshold | Hesaplanıyor, tüketilmiyor | Uygulanır | DEFERRED | PA | P0 | 245 | B05 | app/security/step_up.py, app/voice/realtime_sessions/service.py:handle_tool_call | test_voice_step_up.py | sahip kararı 2026-09-19: ses izi kimlik doğrulaması istenmiyor | no | Karar yolu gölge modda kalır; sahip ikinci ses onayını ve ses izini istemiyor (ADR-0171 eki). VoiceIdentity yalnız dinleme modunda filtre. |
| 248 | Sensitive-command higher threshold | Yok | Eşik yükselir | DEFERRED | PA | P0 | 247 | B05 | app/security/step_up.py, app/voice/realtime_sessions/service.py:handle_tool_call | test_voice_step_up.py | sahip kararı 2026-09-19: ses izi kimlik doğrulaması istenmiyor | no | Karar yolu gölge modda kalır; sahip ikinci ses onayını ve ses izini istemiyor (ADR-0171 eki). VoiceIdentity yalnız dinleme modunda filtre. |
...
| 267 | Safe tone fallback | Anahtar yoksa sessizce sinüs tonu, testi yok | Testli ve duyurulan yedek | DONE | PR | P1 | 234 | B13 | app/alarms/greeting_audio.py, app/alarms/sequence.py, app/alarms/service.py:alarm_dict | test_alarms_sequence.py (42) | üretim turu fce0a83 (docs/evidence/pc-production-round-2026-09-17-021119.json) | no | 110 Hz vızıltı artık KARŞILAMA diye çalınmıyor; `greeting_failure="no_tts_key"` satırda okunuyor. Yedek yolu duruyor ve sınanıyor — sadece sahibe sunulmuyor |
...
| 270 | Greeting | Çalışıyor (sesli karşılama) | Brifingle zenginleşir | DONE | PR | P1 | — | B15 | app/alarms/sequence.py:_speak_briefing | test_briefing_delivery.py (21) | üretim turu fce0a83 (docs/evidence/pc-production-round-2026-09-17-021119.json) | TTS kotası | Karşılama önce, brifing sonra — AYNI duck penceresinde; "Günaydın efendim" yarı uykulu birine gürültünün bittiğini söyleyen cümle |
| 271 | Current time | Brifingde var, niyet yok | Sesle sorulabilir | DONE | PR | P1 | 726 | B15 | app/voice/intents.py:_clock_match, app/voice/realtime_sessions/tools.py:clock_now, app/briefing/service.py:local_now | corpus c.* (6), test_voice_intents.py (138) | üretim turu fce0a83 (docs/evidence/pc-production-round-2026-09-17-021119.json) | no | Cümle brifingde vardı, niyeti yoktu — ve `clock.now` ham ISO damgası dönüyordu. İkisi de düzeldi; brifingin KENDİ biçimlendiricisi okunuyor, ikinci bir tane doğmadı. Alarm ailesinden SONRA çözülüyor |
| 272 | Weather | Canlı ses oturumu istiyor | Tarayıcısız | DONE | PR | P1 | 281 | B15 | app/briefing/delivery.py, app/alarms/sequence.py | test_briefing_delivery.py (21) | üretim turu fce0a83 (docs/evidence/pc-production-round-2026-09-17-021119.json) | no | Tarayıcısız: alarm yolu brifingi okuyor. İçerik 273'e bağlı |
| 273 | Location | Kısmi | Çalışır | DONE | PR | P1 | 272 | B15 | app/location/service.py (altı kademe), app/voice/.../tools_weather.py:location_set_default | test_location_service.py (11) | üretim turu fce0a83 (docs/evidence/pc-production-round-2026-09-17-021119.json) | no | Mekanizma uçtan uca çalışıyor: sahip "İstanbul'u varsayılan yap" diyebiliyor. AYARLANMAMIŞ olduğu sürece brifing dürüstçe "neredesiniz bilmiyorum" diyor — kusur değil, boş bir ayar |
| 274 | System status | Canlı ses oturumu istiyor | Tarayıcısız | DONE | PR | P1 | 281 | B15 | app/briefing/service.py, app/briefing/delivery.py | test_briefing_service.py (12), test_briefing_delivery.py (21) | üretim turu fce0a83 (docs/evidence/pc-production-round-2026-09-17-021119.json) | no | Tarayıcısız |
| 275 | Overnight task summary | Canlı ses oturumu istiyor | Tarayıcısız | DONE | PR | P1 | 281 | B15 | app/briefing/service.py, app/briefing/delivery.py | test_briefing_service.py (12), test_briefing_delivery.py (21) | üretim turu fce0a83 (docs/evidence/pc-production-round-2026-09-17-021119.json) | no | Tarayıcısız |
...
| 285 | Alarm history | Kısmi | Tam | DONE | PR | P1 | — | B13 | app/alarms/history.py, app/alarms/routes.py | test_alarms_history.py (10) | üretim turu fce0a83 (docs/evidence/pc-production-round-2026-09-17-021119.json) | no | YENİ TABLO YOK: defter zaten tutuyordu, kimse geri okuyamıyordu. Tekrarlayan alarmın SATIRI dünü unutuyor (`_release` geri sarıyor) — defter unutmuyor |
...
| ID | FEATURE | CURRENT_STATUS | TARGET_STATUS | IMPL | PROOF | PRI | DEPS | BATCH | SOURCE_REFERENCES | TEST_REFERENCES | RUNTIME_PROOF | OWNER_ACTION | NOTES |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 367 | Durable notification table | Bellek içi kuyruk; yeniden başlatmada kaybolur | Kalıcı tablo | DONE | PR | P1 | — | B11 | app/notifications/models.py, app/notifications/service.py | test_notifications.py | üretim turu fce0a83 (docs/evidence/pc-production-round-2026-09-17-021119.json) | no | Bellek içi deque bitti: satır her denemeden ÖNCE yazılıyor |
| 368 | In-app inbox | Kalıcı değil | Kalıcı kutu | DONE | PR | P1 | 367 | B11 | app/notifications/models.py, app/notifications/service.py, app/notifications/routes.py, apps/web/app/lib/cockpit/notifications.ts, apps/web/app/core/panels/CockpitPanels.tsx | test_notifications.py, notifications-panel.test.tsx (29) | üretim turu fce0a83 (docs/evidence/pc-production-round-2026-09-17-021119.json) | no | Kutu tabloyu okuyor, hiçbir taşıyıcıya sormuyor. Panel üç durumu AYRI söylüyor: hiçbir kanal taşımadı / iletildi, okunmadı / okundu |
...
| 376 | Delivery retry | Sınırsız | Sınırlı + karantina | DONE | PR | P0 | 14 | B07 | app/notifications/delivery.py | test_bounded_delivery.py | üretim P0 turu 6fa7dfe (docs/evidence/p0-production-round-2026-09-17-040952.json) | no | 14 ile tek uygulama |
| 377 | Delivery history | Kısmi | Tam | DONE | PR | P1 | 367 | B11 | app/notifications/models.py, app/notifications/service.py, app/notifications/routes.py | test_notifications.py | üretim turu fce0a83 (docs/evidence/pc-production-round-2026-09-17-021119.json) | no | Ulaşılamayanlar da listede — asıl önemli kısım o |
...
| 379 | Quiet hours | Yok | Sessiz saatler | DONE | PR | P1 | 378 | B11 | app/notifications/models.py, app/notifications/service.py | test_notifications.py | üretim turu fce0a83 (docs/evidence/pc-production-round-2026-09-17-021119.json) | no | Gürültü hakkında, gizleme hakkında değil: ertelenen satır kutuda duruyor — 2026-09-16: pencere UTC saatine göre ölçülüyordu (İstanbul'da gece 02:00–10:30 oluyordu); artık Europe/Istanbul duvar saatinde, regresyon test_quiet_hours_are_the_owner_s_night_not_utc_s (RED kanıtlı) |
...
| 382 | "Task failed" | Kısmi | Gerçek teslim | DONE | PR | P1 | 375 | B12 | app/notifications/events.py, app/artifacts/service.py | test_notification_events.py (17) | üretim turu fce0a83 (docs/evidence/pc-production-round-2026-09-17-021119.json) | no | Sahibe hata SINIFI gidiyor, traceback değil |
...
| 389 | Notification fallback ladder | Yok | toast to ses to push to kutu | DONE | PR | P1 | 367,369 | B11 | app/notifications/ladder.py | test_notifications.py | üretim turu fce0a83 (docs/evidence/pc-production-round-2026-09-17-021119.json) | no | toast→ses→push→kutu; kutu zemin, o yüzden merdiven düşemez |
...
| 393 | XLSX | Kod gerçek; her sürüm provenans + kaynak manifesti taşır (B42) | Üretimde kanıtlanır | DONE | PR | P1 | — | B42 | app/artifacts/renderers.py; provenance.py | test_artifact_renderers.py; test_artifact_validation.py | üretim duman turu fce0a83 (docs/evidence/artifacts-production-round-2026-09-17-030155.json) | no | Üretim VM'de bir xlsx üretilip indirilmesi sahibin (checkpoint 18) |
| 394 | PPTX | Kod gerçek; her sürüm provenans + kaynak manifesti taşır (B42) | Üretimde kanıtlanır | DONE | PR | P1 | — | B42 | app/artifacts/renderers.py; provenance.py | test_artifact_renderers.py; test_artifact_factory.py | üretim duman turu fce0a83 (docs/evidence/artifacts-production-round-2026-09-17-030155.json) | no | Checkpoint 18 |
...
| 398 | CSV | Kod gerçek; her sürüm provenans + kaynak manifesti taşır (B42) | Üretimde kanıtlanır | DONE | PR | P1 | — | B42 | app/artifacts/renderers.py; provenance.py | test_artifact_renderers.py | üretim duman turu fce0a83 (docs/evidence/artifacts-production-round-2026-09-17-030155.json) | no | Checkpoint 18 |
| 399 | JSON | Kod gerçek; her sürüm provenans + kaynak manifesti taşır (B42) | Üretimde kanıtlanır | DONE | PR | P1 | — | B42 | app/artifacts/renderers.py; provenance.py | test_artifact_renderers.py | üretim duman turu fce0a83 (docs/evidence/artifacts-production-round-2026-09-17-030155.json) | no | Checkpoint 18 |
...
| 473 | Signing optional/test cert | Companion'ın kendinden imzalı kod imzalama kimliği (RSA-3072, `CN=PagentOS Owner Test Signing`, EKU yalnız kod imzalama, CA=false, 2 yıl, CurrentUser\My, CNG anahtarı DIŞA AKTARILAMAZ, parmak iziyle yeniden kullanılır, bitişe 30 gün kala yenilenir); MSIX süreç içinde `SignerSignEx2` ile imzalanır, `WinVerifyTrust` + `AppxSignature.p7x` ile geri okunur, okunamazsa paket silinir; `project.install kind=msix` güvenilmeyen imzacıyı `signing_cert_untrusted` ile reddeder ve betiği adlandırır, güvenilirse Windows PackageManager ile kullanıcıya kurar ve kaydı okur; `scripts/trust-native-signing-cert.ps1` yalnız genel sertifikayı LocalMachine\TrustedPeople'a alır | Test sertifikası | DONE | PA | P1 | 472 | B33 | Native/OwnerSigningIdentity.cs; Native/PackageSigner.cs; Native/MsixDeployment.cs; NativeLifecycle.cs:SignAndReadBack,InstallMsix; scripts/trust-native-signing-cert.ps1; scripts/lib/NativeSigningTrust.ps1 | NativeSigningIdentityTests (9), NativePackageSigningTests (8), NativeMsixInstallTests (8), NativeSigningTests (+2), native-signing-trust.tests.ps1 (70), mutasyon M1-M11 (güvenlik incelemesi: dışa aktarılabilir / yabancı adlı anahtar reddi, parmak izi eşleşmesi) | lab gerçek: imza 0x800B0109, kurcalama 0x80096010, Windows PackageManager güvenilmeyen paketi kendisi reddetti (0x800B0109), olmayan paket kaldırma 0x80073CF1 | güven adımı (READY_FOR_OWNER): yönetici PowerShell'de bir kez `powershell -NoProfile -ExecutionPolicy Bypass -File .\scripts\trust-native-signing-cert.ps1`; önce yeni cihaz ajanının dağıtımı ve bir MSIX paketlemesi | güvenilir kurulumun başarılı yolu yalnız sahibin adımından sonra gerçek makinede kanıtlanabilir; taşınabilir EXE Authenticode kapsam dışı |
| 474 | Android project generation | `counter-mobile` gerçek bir Gradle Kotlin DSL projesi üretir (kök settings/build, `app` modülü, AndroidManifest, string kaynağı, MainActivity, saf `Counter` ve JVM birim testi); masaüstü şablonuyla aynı yuva disiplini, uzantı izin listesi ve M23 politikası; paket kimliği sluga göre türetilir (rakamla başlamaz, ayrılmış sözcük olmaz), versionCode her sürümde büyür, başlık strings.xml için kaçışlanır; Gradle sarmalayıcısı bilinçli olarak YOK (betik render edilmez) | Üretilir | DONE | PA | P3 | 425 | B49 | app/nativefactory/generator.py:android_package/android_version_code/android_string_resource; templates/counter-mobile/ | test_nativefactory_b49.py (XML olarak ayrıştırılan manifest ve kaynak; Gradle kimlikleri; paket bildirimleri; politika; diske üretim; JDK'sız derleme reddi) | proje derlemesi PR: docs/evidence/b49-android-runtime-qualification-2026-09-16.json; cihazda: AndroidBuildTests (gerçek Gradle derlemesi, companion'ın iş nesnesi içinde) | no | v1.0'ı bloklamaz |
| 475 | APK | Fabrika APK'yı kayıtlı cihazda derler: cihaz `native` kökünde üç sabit Gradle biçimini kabul eder (`gradle --no-daemon --console=plain assembleDebug`, `bundleRelease`, `test`; yol, özellik, init betiği yok), Gradle'ı yapılandırılmış JDK'nın java.exe'siyle başlatıcı jar üzerinden çalıştırır (kabuk ve PATH yok), JVM ajan/özellik değişkenlerini temizler; sayılar JUnit raporlarından, kimlik APK'nın kendi manifestinden okunur ve Cloud Core paket adı + versionCode + versionName karşılaştırır. Yolda: cihaz komutlarına 30 sn süre veriliyordu (her uzun derleme kesilirdi) ve başarısız derleme teste geçiyordu - ikisi düzeltildi. Kalan: yeni cihaz ajanının canlı cihaza dağıtımı (READY_FOR_OWNER, madde 624) | Üretilir | PARTIAL | PR | P3 | 474 | B49 | ProjectManifest.cs (Gradle biçimleri); NativeTools.cs:RequireGradle; ProjectRunner.cs:ApplyGradleEnvironment; JUnitReports.cs; AndroidPackageReader.cs; app/nativefactory/device_build.py:android_manifest/_read_back_android; artifacts.py:validate_against_spec; stacks.py:choose_on_device | AndroidBuildTests (gerçek Gradle derlemesi, companion'ın iş nesnesi içinde) · test_nativefactory_device_build.py (Android) · test_voice_native_tools.py (cihazda planlanır, yerel runner hiç çağrılmaz) · scripts/qualify-android-factory.ps1 | PR: AndroidBuildTests (gerçek Gradle derlemesi, companion'ın iş nesnesi içinde); docs/evidence/b49-android-runtime-qualification-2026-09-16.json (apk sha256 dea008bddce1d3cc…) | yeni cihaz ajanının canlı cihaza dağıtımı (READY_FOR_OWNER, madde 624) | Madde 33: JDK/Gradle/cmdline-tools sahip izniyle kuruldu (E:\AI\toolchains); cihaz ayarı PAGENTOS_AGENT_NativeJavaHome / NativeGradleHome |
| 476 | AAB | Aynı hat, `bundleRelease` ile: AAB'nin protobuf manifesti cihazda okunur, kimlik doğrulanır. İMZASIZ: yükleme anahtarı sahibindir ve cihaz imza aracı çalıştırmaz (apksigner / jarsigner / keytool adıyla reddedilir). Kalan: yeni cihaz ajanının canlı cihaza dağıtımı (READY_FOR_OWNER, madde 624) | Üretilir | PARTIAL | PR | P3 | 475 | B49 | device_build.py:ANDROID_RUN_KEY; AndroidPackageReader.cs:ReadProtoXml | AndroidBuildTests (gerçek Gradle derlemesi, companion'ın iş nesnesi içinde) · test_nativefactory_device_build.py (bundle satırı) | PR: AndroidBuildTests (gerçek Gradle derlemesi, companion'ın iş nesnesi içinde); docs/evidence/b49-android-runtime-qualification-2026-09-16.json (aab sha256 fdc45c07f5618b30…, signed=false) | yeni cihaz ajanının canlı cihaza dağıtımı (READY_FOR_OWNER, madde 624); Play yükleme anahtarı | — |
| 477 | Android emulator test | APK, pencere açmadan başlatılan AVD'de (Android 13, x86_64, WHPX) kuruldu ve açıldı: `am start -W` Status ok, MainActivity ön planda; '+' iki kez dokunuldu, sayaç UI ağacında 0 → 2 okundu; emülatör her yolda kapatılır; olmayan AVD ile betik `boot` kapısında düşer. Fabrika APK'yı kendisi açmaz (native.launch Android için adıyla reddeder) | Koşar | PARTIAL | PR | P3 | 475 | B49 | scripts/qualify-android-factory.ps1; tools_native.py:SPEECH_ANDROID_LAUNCH_NOT_WIRED | qualify-android-factory.ps1 (boot / launch / operate / stop) | PR: docs/evidence/b49-android-runtime-qualification-2026-09-16.json (ekran görüntüsü sha256 kayıtlı) | karar: emülatör/telefon başlatma yolu (cihazda yeni program biçimi = güvenlik kararı) | AVD: pagentos-b49 |
| 478 | Android device test | Fiziksel cihaz gerekir; emülatör kanıtı (477) bunun yerini tutmaz | Koşar | BLOCKED_PROVIDER | NYP | P3 | 477 | B49 | app/nativefactory/ | — | — | fiziksel Android telefon + USB hata ayıklama (READY_FOR_OWNER) | aynı betik gerçek cihaza uyarlanabilir (scripts/qualify-android-factory.ps1) |
| 479 | iOS explicit NOT_SUPPORTED without macOS | iOS/iPhone/iPad isteği `platform_unreachable` ile adıyla reddedilir (satır açılmaz); Türkçe sahip mesajı artık katalogda (hata dili korumasına görünmüyordu); araç zinciri rotası `ios: false` yanında `ios_reason: macos_required` der; M28 spesifikasyonu olmayan `ios_project` hedefini listelemeyi bıraktı | Açıkça reddedilir | DONE | PA | P2 | — | B49 | app/nativefactory/stacks.py:refuse_ios; tools_native.py:ERROR_PLATFORM_UNREACHABLE; routes.py:toolchain; errors/catalog.py | test_nativefactory_b49.py (üç iOS sözcüğü; katalog; rota) · test_voice_native_tools (satır açılmaz) | — | no | Unity lisans reddi deseni |
...
| 520 | Scene inspect | Okuma: nesneler (dönüşüm, malzeme rengi + metallic/roughness, kamera lens), ışıklar (enerji + renk), kare aralığı, F-curve'lerden anahtar kareler, dışa aktarımlar; cihaz render'ı ve her dışa aktarımı yerinde doğrular (göreli yol, sha256, biçim imzası) | Tam | DONE | PR | P2 | — | B44 | app/creative3d/drivers/blender_driver.py:build_inspection/animation_tracks; SceneInspection.cs:ReadExports | test_creative3d_b44.py (sürücü okuması; sahte cihaz = cihaz anahtarları, C# kaynağından) · SceneExportTests.cs | üretim 3D turu 6fa7dfe (docs/evidence/3d-production-round-2026-09-17-040922.json) | no | Unity okuması sabit (pinli sürücü) |
| 521 | Production scene creation | POST /v1/scenes (sesli araçla aynı SceneService.create, aynı cihaz portu). Yolda bulunan iki sözleşme hatası kapatıldı: sürücü render'ı MUTLAK yolla bildiriyordu (cihaz reddeder) ve bulut render baytlarını cihazın hiç göndermediği `render_png_base64` anahtarından okuyordu (cihaz `render.png_base64`) — gerçek hiçbir render buluta ulaşamazdı | Üretimde sahne | DONE | PR | P2 | — | B44 | app/creative3d/routes.py:create_scene; service.py:_inspect_device; blender_driver.py:do_render | test_creative3d_b44.py (REST oluşturma; cihaz şekilli render buluta ulaşır) · SceneExportTests (gerçek Blender, gönderilen sürücü) | üretim 3D turu 6fa7dfe (docs/evidence/3d-production-round-2026-09-17-040922.json) | no | Sahte cihaz artık cihazın şeklinde cevaplar ve reddeder |
...
| 530 | Unity project create | Bulut her Unity iskeletine sabitlenmiş (sha256) `Packages/manifest.json` (Newtonsoft + imageconversion) ve üç katalog betiği gönderir; lisanslı editör projeyi açar, sürücüyü derler | Çalışır | DONE | PR | P3 | 529 | B50 | app/creative3d/service.py:unity_support_files; drivers/unity_support/; drivers/manifest.json | SceneUnityProductionTests.cs (gerçek lisanslı Unity 6000.5.0f1); test_creative3d_b50.py (bulut compare gerçek çıktı üzerinde); SceneBoundsTests.cs | üretim 3D turu (Unity) fce0a83 (docs/evidence/3d-production-round-2026-09-17-021631.json) | no | ADR-0164. İlk lisanslı koşuda sürücü Newtonsoft olmadan derlenmiyordu ve iş nesnesinin 32 süreç sınırı derleyicileri başlatamıyordu (1816) — ikisi de kapatıldı; üretimde canlı tur bulut sürümü + cihaz yeniden kurulumu sonrası |
| 531 | Unity scene create | Üretim sürücüsü (SceneDriver.cs) sahneyi kurar, kaydeder, GPU ile render alır; cihaz render'ı yerinde doğrular; bulut compare 20 kısıtı gerçek çıktı üzerinde kabul eder | Çalışır | DONE | PR | P3 | 530 | B50 | app/creative3d/drivers/SceneDriver.cs; app/creative3d/compare.py:unity_forward_vector; ProjectManifest.cs:UnityForm | SceneUnityProductionTests.cs (gerçek lisanslı Unity 6000.5.0f1); test_creative3d_b50.py (bulut compare gerçek çıktı üzerinde); SceneAllowlistTests.cs; test_scene_service.py | üretim 3D turu (Unity) fce0a83 (docs/evidence/3d-production-round-2026-09-17-021631.json) | no | Gerçek çıktı üç hata gösterdi: `-nographics` altında render tek renkti (komut artık bayraksız; eski biçim kabul edilir, sürücü dürüstçe hata verir), kamera yönü Blender ekseniyle ölçülüyordu (180°), ayrıntı sayıları tr-TR virgülüyle yazılıyordu |
| 532 | Unity build | `build_player`: kaydedilen sahne BuildPipeline ile Windows oyuncusu olarak derlenir (`Build/<sahne>.exe`); bulut EXE'yi cihazın `file.inspect`'i ile geri okur (PE bloğu + sha256 editörünkiyle aynı) | Çalışır | DONE | PR | P3 | 530 | B50 | spec.py:BuildPlayer; SceneDriver.cs:BuildPlayer; service.py:_read_back_build; compare.py | SceneUnityProductionTests.cs (gerçek lisanslı Unity 6000.5.0f1); test_creative3d_b50.py (bulut compare gerçek çıktı üzerinde) | üretim 3D turu (Unity) fce0a83 (docs/evidence/3d-production-round-2026-09-17-021631.json) | no | Oyuncu derlemesi 2×çekirdek süreç sınırında yine 1816 verdi; sınır 4×çekirdek (28 çekirdekte 176). Proje dışı yol cihaza hiç sorulmaz |
| 533 | Unity test | `run_tests`: eklenen her katalog betiği kendi `Step(dt)` yöntemiyle N kare adımlanır ve etki ölçülür (Spinner 45°, Bouncer 0.5, ColorCycler renk); nesne sonra geri yüklenir | Çalışır | DONE | PR | P3 | 532 | B50 | spec.py:RunTests; SceneDriver.cs:RunTests; unity_support/Assets/PagentOS/Scripts/*.cs; compare.py | SceneUnityProductionTests.cs (gerçek lisanslı Unity 6000.5.0f1); test_creative3d_b50.py (bulut compare gerçek çıktı üzerinde) | üretim 3D turu (Unity) fce0a83 (docs/evidence/3d-production-round-2026-09-17-021631.json) | no | Betiklerin Update'i aynı Step'i çağırır — test edilen, oyuncunun çalıştırdığıdır |
...
| 558 | Correct final status | Yanlış | Doğru | DONE | PR | P0 | — | B10 | app/executive/activities.py, app/executive/service.py, app/executive/models.py | test_execution_honesty.py | üretim P0 turu 6fa7dfe (docs/evidence/p0-production-round-2026-09-17-040952.json) | no | steps_done artık yalnız VERIFIED sayıyor |
| 559 | No false "4/4 completed" | İki koşu yalan söylüyor | Dürüst | DONE | PR | P0 | 558 | B10 | app/executive/activities.py, app/executive/service.py, app/executive/models.py | test_execution_honesty.py | üretim P0 turu 6fa7dfe (docs/evidence/p0-production-round-2026-09-17-040952.json) | no | '4/4' kırmızıyla kanıtlandı: assert 4 == 1 |
| 560 | Task reconciliation | Yok | Mutabakat | DONE | PR | P0 | 11 | B10 | app/executive/reconcile.py, app/main.py | test_executive_reconcile.py (31) | üretim P0 turu 6fa7dfe (docs/evidence/p0-production-round-2026-09-17-040952.json) | no | ÖLÇÜM DÜZELTMESİ: MISSING değildi — kod var, saate bağlı, 31 testi geçiyor |
...
| 614 | Post-release rollback | Kısmi (timer yok) | Otomatik | DONE | PR | P0 | 652 | B08 | services/recovery-supervisor/, scripts/cloud/install-recovery-supervisor.sh | test_systemd_install.py | üretim tatbikatı 2026-09-18 (docs/evidence/b08-recovery-supervisor-2026-09-18.json) | no | Kasten bozuk sürüm 139,7 s içinde otomatik geri alındı; sahip müdahalesi olmadan hizmet döndü |
...
| 647 | Backup failure notification | `OnFailure=` yok | Bildirilir | DONE | PR | P0 | 646 | B08 | infra/systemd/pagentos-failure-marker@.service, infra/systemd/*.service | test_backup_health.py, test_systemd_onfailure_units.py | üretimde canlı işaret probu + tatbikat C (docs/evidence/b08-recovery-supervisor-2026-09-18.json) | no | İşaret yazıldı, ürün degraded dedi ve birimi adıyla gösterdi; kurtulunca temizlendi — kredi yok, ağ yok |
...
| 651 | Recovery supervisor | Servis `main`'de, timer değil | Kurulu | DONE | PR | P0 | — | B08 | services/recovery-supervisor/, scripts/cloud/install-recovery-supervisor.sh | test_systemd_install.py (842 satır) | /opt/pagentos-recovery, sha256 sabitli paket (docs/evidence/b08-recovery-supervisor-2026-09-18.json) | no | Her çalıştırmadan önce reconcile.sh, compose ve nginx bütünlüğü doğrulanıyor |
| 652 | Recovery systemd timer | `main`'de YOK | Kurulu | DONE | PR | P0 | 651 | B08 | infra/systemd/pagentos-bluegreen-reconcile.timer | test_systemd_install.py, test_systemd_onfailure_units.py | timer aktif; tespit 14 sn ve 62 sn ölçüldü (docs/evidence/b08-recovery-supervisor-2026-09-18.json) | no | 60 sn'lik tur; kilit tutulduğunda exit 82 artık başarı sayılıyor, arıza değil |
| 653 | Healthy to degraded detection | Kısmi | Tam | DONE | PR | P0 | 652 | B08 | services/recovery-supervisor/, scripts/cloud/install-recovery-supervisor.sh | test_health_policy.py | A, B ve C tatbikatları üretimde (docs/evidence/b08-recovery-supervisor-2026-09-18.json) | no | Durdurulan renk 30,2 sn'de, imajı silinen renk 72 sn'de geri geldi |
| 654 | Automatic rollback | Kısmi | Tam | DONE | PR | P0 | 653 | B08 | services/recovery-supervisor/, scripts/cloud/release-cloud-core-bluegreen.sh | cloud-release-bluegreen.tests.ps1, test_health_failing_checks.py | tatbikat C: exit 81, 139,7 sn (docs/evidence/b08-recovery-supervisor-2026-09-18.json) | no | Ayağa kalkmayan renk yerine diğer rengin son iyi sürümü yüksek sesle devraldı; terfi ilan edilmedi |
| 655 | Recovery audit | Kısmi | Tam | DONE | PR | P0 | 654 | B08 | services/recovery-supervisor/recovery_supervisor/incidents.py | test_incidents.py | journal + exit 81 + işaret + RELEASE.json + app.interrupted (docs/evidence/b08-recovery-supervisor-2026-09-18.json) | no | Başarısız aday silinmiyor, app.interrupted olarak saklanıyor; env dosyası bit bit aynı kaldı |
...
| 659 | Idle session lifetime | Kısmi | Tam | DONE | PR | P0 | 658 | B05 | app/identity/service.py:_past_absolute_lifetime, :sweep_expired | test_authority_gate.py | üretim P0 turu 6fa7dfe (docs/evidence/p0-production-round-2026-09-17-040952.json) | no | Atıl kural artık süpürgede de: jeton sunulmasa da oturum kapanıyor |
...
| 663 | Device trust | Çağıranın gönderdiği boolean | Sunucuda doğrulanır | DONE | PR | P0 | — | B05 | app/voice/device_trust.py, app/voice/routes.py:verify_speaker_route | test_authority_gate.py | üretim P0 turu 6fa7dfe (docs/evidence/p0-production-round-2026-09-17-040952.json) | no | 246 ile tek uygulama; oturumun cihaz bağı + cihazın canlı olması |
| 664 | Speaker verification | Tavsiye niteliğinde | Karar yolunda (tek başına kök DEĞİL) | DEFERRED | PA | P0 | 663 | B05 | app/security/step_up.py, app/voice/realtime_sessions/service.py:handle_tool_call | test_voice_step_up.py | sahip kararı 2026-09-19: ses izi kimlik doğrulaması istenmiyor | no | Karar yolu gölge modda kalır; sahip ikinci ses onayını ve ses izini istemiyor (ADR-0171 eki). VoiceIdentity yalnız dinleme modunda filtre. |
| 665 | Speaker embedding | Kısmi | Tam | DEFERRED | PA | P0 | 664 | B05 | app/security/step_up.py, app/voice/realtime_sessions/service.py:handle_tool_call, app/voice/models.py:SpeakerVerdictRow | test_voice_step_up.py | sahip kararı 2026-09-19: ses izi kimlik doğrulaması istenmiyor | no | Karar yolu gölge modda kalır; sahip ikinci ses onayını ve ses izini istemiyor (ADR-0171 eki). VoiceIdentity yalnız dinleme modunda filtre. |
| 666 | Sensitive-operation re-auth | Yok | Yeniden doğrulama | DEFERRED | PA | P0 | 658 | B05 | app/security/step_up.py, app/voice/realtime_sessions/service.py:handle_tool_call | test_voice_step_up.py | sahip kararı 2026-09-19: ses izi kimlik doğrulaması istenmiyor | no | Karar yolu gölge modda kalır; sahip ikinci ses onayını ve ses izini istemiyor (ADR-0171 eki). VoiceIdentity yalnız dinleme modunda filtre. |
| 667 | Secret detection | Çalışıyor | Aynı | DONE | PA | P0 | — | — | app/security/ | security testleri | 13 desen | no | Tespit var, uygulama eksik |
| 668 | Secret redaction | Desenler log hattında ve dünya modelinde yok | Her yüzeyde | DONE | PR | P0 | 667 | B04 | app/worldmodel/state.py:_Collector.fact, app/logging.py:redact_secrets, app/logging.py:SecretRedactingFilter, app/health.py:_run_check, app/main.py:system_health | test_secret_redaction_surfaces.py | üretim P0 turu 6fa7dfe (docs/evidence/p0-production-round-2026-09-17-040952.json) | no | Tek kelime dağarcığı: 13 desen app.memory.policy'den, anahtar adları app.research.forbidden_keys'ten |
...
| 683 | No secret logging | İhlal var | Hiçbir sır loglanmaz | DONE | PR | P0 | 668 | B04 | app/logging.py:redact_secrets, app/logging.py:SecretRedactingFilter | test_secret_redaction_surfaces.py | üretim P0 turu 6fa7dfe (docs/evidence/p0-production-round-2026-09-17-040952.json) | no | Anahtar-adı kuralı her derinlikte, ama yalnız dize değerlere: tokens:1430 sayı kalıyor |
...
| 736 | "Dosyayı gönder" | Onay ÇIPLAK olmak zorunda | Yanlış yönlenmez | DONE | PR | P0 | — | B26 | app/voice/intents.py:_is_bare, _mail_send_match | test_intent_misroutes.py (46), test_route_telemetry.py (16) | üretim P0 turu 6fa7dfe (docs/evidence/p0-production-round-2026-09-17-040952.json) | no | Eşleştirici yalnız mail ismini reddediyordu; DİĞER her isim geçiyordu. Bu ailede geri alınamayan tek eylem |
| 737 | "Bunu yazdır" | `yazdır` artık `yaz` değil | Yanlış yönlenmez | DONE | PR | P0 | — | B26 | app/voice/intents.py:_write_verb, _WRITE_VERB_RE | test_intent_misroutes.py (46), test_route_telemetry.py (16) | üretim P0 turu 6fa7dfe (docs/evidence/p0-production-round-2026-09-17-040952.json) | no | Türkçe ek üretir: `yazdır` ettirgen = BASTIR. Ön ek eşleşmesi odaktaki pencereye yazıyordu. Kapalı liste + aynı sözcüklerle lookahead (iki yarı ayrışamaz) |
| 738 | "Otomatik güncellemeleri kapat" | `otomatik` ekran ister | Yanlış yönlenmez | DONE | PR | P0 | — | B26 | app/voice/intents.py:_ambient_policy_match, ambient_policy_changes | test_intent_misroutes.py (46), test_route_telemetry.py (16) | üretim P0 turu 6fa7dfe (docs/evidence/p0-production-round-2026-09-17-040952.json) | no | Kapı "ekran yok VE otomatik yok → bizim değil" diyordu: çıplak sözcük ikinci bir kapıydı. Güncelleme, yedekleme ve otomatik kaydetme hepsi oradan geçti. Yazan yarı da daraltıldı |
| 739 | Wrong-route negatives | 107 cümle, her biri NE OLMAMALI ile | Negatif külliyat | DONE | PR | P0 | 736 | B26 | services/api/tests/voice_corpus/routing.py | test_intent_misroutes.py (46), test_route_telemetry.py (16) | üretim P0 turu 6fa7dfe (docs/evidence/p0-production-round-2026-09-17-040952.json) | no | Her vaka iki alan taşıyor: nereye gitmeli VE nereye ASLA gitmemeli. `expected=None` olan (B27'nin onu) yine de eyleme ulaşırsa düşüyor. Ölçüm 103'tü; küme yalnız büyüyebilir |
| 740 | Semantic model router | Kuralların yönlendiremediği cümle, sahip bayrağıyla (`voice_model_router_enabled`, varsayılan kapalı) modele sorulur; model yalnızca aday listesinden tek bir araç seçer, güveni 0.7 altındaysa seçim alınmaz; anahtar yoksa istek hiç gitmez, hata sessizliğe düşer; kuralların yönlendirdiği cümle modele asla gitmez | Model yönlendirici | DONE | PA | P2 | 741 | B51 | app/voice/intent_router.py:CompositeIntentRouter/AnthropicIntentModel; realtime_sessions/service.py | test_intent_router_b51.py (bayrak kapalı; kural önceliği; güvenli aday; ret; düşük güven; tek araç zorlaması; anahtarsız sessizlik) | gerçek model bütçesi READY_FOR_OWNER | model bütçesi | Kritik fiiller hariç (741 dokunulmadı) |
| 741 | Deterministic safety router | Kalkan; dört daraltma, 20 koruma cümlesi | Güvenlik kalkanı rolü | DONE | PR | P0 | — | B26 | app/voice/intents.py | test_intent_misroutes.py (46), test_route_telemetry.py (16), test_voice_intents.py, test_owner_utterance_corpus.py (2063) | üretim P0 turu 6fa7dfe (docs/evidence/p0-production-round-2026-09-17-040952.json) | no | Her düzeltme bir DARALTMA — çalışan cümleyi yanında götürmeye en yatkın değişiklik. Her biri aynı koşuda dokunmaması gereken cümlelerle eşleniyor |
| 742 | Tool registry-driven routing | Aday listesi araç kaydından türetilir: kayıtlı aracı olmayan niyet aday olamaz; eylemli niyetler, dur ve göz kapatma listeye hiç girmez (156 aday) | Araç kaydından | DONE | PA | P2 | 740 | B51 | app/voice/intent_router.py:model_candidates/registry_candidates | test_intent_router_b51.py (eylemli niyet yok; kayıtlı araç şartı) | — | no | 701 ile ortak |
| 743 | Intent confidence | Her yönlendirme bir güven skoru taşır: kural yolu kesin, tek sözcüklü eylem en düşük kural güveni, atılan dolgu sözcükleri biraz düşürür, yönlendirilmeyen 0; skor ve kaynak (rule/model/none) tur kaydına yazılır | Güven skoru | DONE | PA | P2 | 740 | B51 | app/voice/intent_router.py:score_confidence; service.py turn record route_source/route_confidence | test_intent_router_b51.py (kural/yok; tek sözcük; dolgu) | — | no | — |
...
| 749 | Route telemetry | Her çözümleme kayıtlı, sözler DEĞİL | Telemetri | DONE | PR | P0 | — | B26 | app/voice/route_telemetry.py, app/voice/realtime_sessions/service.py | test_route_telemetry.py (16) | üretim P0 turu 6fa7dfe (docs/evidence/p0-production-round-2026-09-17-040952.json) | no | Niyet, eşleşen kural, yönlendi mi. Deşifre YOK: sistemin işlediği en özel şey ve dedektörün ona ihtiyacı yok. Tek istisna sekiz sözcüklük kapalı tepki kümesi |
| 750 | Misroute auto-detection | Sahibin İTİRAZI sinyaldir | Otomatik tespit | DONE | PR | P0 | 749 | B26 | app/voice/route_telemetry.py:candidates, observe | test_route_telemetry.py (16) | üretim P0 turu 6fa7dfe (docs/evidence/p0-production-round-2026-09-17-040952.json) | no | Yönlendirici kendi hatasını göremez — görebilseydi yapmazdı. Görebildiği şey sahibin SONRA ne yaptığı: eylemli niyetten 12 sn içinde dur/vazgeç/hayır. ADAY dedektörü: rapor eder, yol değiştirmez. Bir itiraz bir eylemi adlandırır |
