...
| 369 | Desktop toast | desktop.notify artık companion'a gerçekten bağlı (B47 ve B48'de ayrı ayrı bulundu, birleştirmede tek bağlama kaldı: Program hiç NotifyCapabilities kurmuyordu, her toast capability_missing) | desktop.notify | PARTIAL | PA | P1 | 5 | B11 | Program.cs:BuildNotify | CameraWiringTests (kompozisyon + fabrika) | cihazda kurulum bekliyor | no | Mutasyon C10 kırmızı |
