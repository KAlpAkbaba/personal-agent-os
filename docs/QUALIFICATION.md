...
Recorded in full because the pattern matters more than any single bug: eight real-machine
runs, eight defects, and **every one of them was in a code path my tests did not execute**.
