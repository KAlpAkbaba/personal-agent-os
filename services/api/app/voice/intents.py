...
class Intent(StrEnum):
    ...
    # M27 (docs/M27_LATEST_NEWS_MODE_SPEC.md §6): Latest News Mode. Two distinct
...
CAPABILITY_BY_INTENT: dict[Intent, str] = {
    ...
    # M27 (spec §6): opening a video and starting a summary run are both real
...
QUERY_TOOL_BY_INTENT: dict[Intent, str] = {
    ...
    # M27 (spec §6): the resolver's own decision, read without opening anything -
...
class ResolvedIntent:
    ...
    #: M27 (docs/M27_LATEST_NEWS_MODE_SPEC.md §6): for NEWS_OPEN/NEWS_SUMMARIZE/
...
def resolve_intent(
    ...
    *,
    ...
    # 0e-3. M27 (docs/M27_LATEST_NEWS_MODE_SPEC.md §6): Latest News Mode. Checked HERE,
