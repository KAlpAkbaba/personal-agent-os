...
ALARM_DISPLAY_GROUNDING_TR = (
    ...
    "'Uyurken ekranları kapat', 'uyuduğumda ekranları kapatma', 'ben yokken ekranları "
    "kapat/kapatma', 'otomatik ekran kapatmayı aç/kapat', 'otomatik ekran yönetimini "
    "aç/kapat', 'ben geri geldiğimde ekranı aç', 'ekranı açık tut' ayarlardır: "
    "ambient.set_policy aracını çağırırsın; olumsuz cümleyi olumluya çevirmezsin, "
    "sunucu sahibin sözünden ayarı kendisi çıkarır. 'Ekran uyku otomasyonunu test et' "
    "denince ambient.test_display. 'Ekranları neden kapattın', 'neden açık bıraktın', "
    "'şu an ekran politikası ne' denince ambient.explain aracını çağırır ve dönen "
    "'speech' metnini aynen okursun; neden uydurmazsın. "
