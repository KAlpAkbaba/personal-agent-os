...
class BenchTargets:
    ...
    rest are PersonalAgentOS provisional numbers (ADR-0035) so the harness has
    ...
    BASIS = {
        ...
        "mic_to_uplink_ms": "PersonalAgentOS provisional (ADR-0035)",
        "tool_preamble_ms": "PersonalAgentOS provisional (ADR-0035)",
        "tool_done_to_speech_ms": "PersonalAgentOS provisional (ADR-0035)",
        "max_audio_gap_ms": "PersonalAgentOS provisional (ADR-0035): no perceptible gap",
...
def build_report(
    ...
    *,
    ...
    notes = [
        "Targets are PersonalAgentOS targets (ADR-0034/ADR-0035), never claims about a provider.",
