...
#: Owner Location Context (docs/DECISIONS.md ADR-0090): where the owner is, by
...
#: Live weather (ADR-0090): a real provider call and the location it was answered for.
...
#: The morning briefing (ADR-0090): one row per assembled/delivered briefing, naming
...
#: Owner Location Context / Live Weather / Morning Briefing (ADR-0090). One row per
