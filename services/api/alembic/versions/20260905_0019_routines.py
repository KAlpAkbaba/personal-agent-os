...
Revision ID: 0019_routines
Revises: 0018_release_lifecycle
...
revision: str = "0019_routines"
# Re-chained onto 0018 on merge: the release-lifecycle migration and this one were
# written on branches that could not see each other and both claimed 0017 as their
# parent, which is two alembic heads and an upgrade that silently applies only one.
# Nothing about this migration depends on 0018; the order is arbitrary and the
# single chain is the point.
down_revision: str | None = "0018_release_lifecycle"
