...
#: M27 (docs/M27_LATEST_NEWS_MODE_SPEC.md §1, §3): a REAL, identity-resolved news
...
#: M27 (docs/M27_LATEST_NEWS_MODE_SPEC.md §5, §6): governed playback opens the
...
#: M27 (docs/M27_LATEST_NEWS_MODE_SPEC.md §1, §3): the fixture channel identity and
...
def _news_negative_cases() -> list[UtteranceCase]:
    ...
    return [
        UtteranceCase(
            ...
            category="news",
            source="regression",
            regression_issue_id="M27 spec §6: 'haber' noun required, never a bare 'aç'",
        ),
        UtteranceCase(
