"""Durable, owner-governed news-source configuration (docs/M27_LATEST_NEWS_MODE_SPEC.md
...
class TestCrossSessionPersistence:
    """Regression (found by the M27 voice corpus, 2026-09-08): every write here MUST
